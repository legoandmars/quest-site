...
function modelPage(allModels, modelType) {
  ...
  initialPage = modelElementList[0];

  var _React$useState = react__WEBPACK_IMPORTED_MODULE_1___default.a.useState(initialPage[0]),
      _React$useState2 = Object(_babel_runtime_helpers_esm_slicedToArray__WEBPACK_IMPORTED_MODULE_0__["default"])(_React$useState, 2),
      selectedPage = _React$useState2[0],
      setSelectedPage = _React$useState2[1];

  function previousPage() {
    if (modelElementList.indexOf(selectedPage) == 0) {
      setSelectedPage(modelElementList[modelElementList.length - 1]);
    } else {
      setSelectedPage(modelElementList[modelElementList.indexOf(selectedPage) - 1]);
    }
  }

  function nextPage() {
    if (modelElementList.indexOf(selectedPage) + 1 == modelElementList.length) {
      setSelectedPage(modelElementList[0]);
    } else {
      setSelectedPage(modelElementList[modelElementList.indexOf(selectedPage) + 1]);
    }
  }
...
//# sourceMappingURL=index.js.28401b27408af1ae35a2.hot-update.js.map