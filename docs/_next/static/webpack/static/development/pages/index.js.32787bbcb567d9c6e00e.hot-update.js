...
function modelPage(allModels, modelType) {
  ...
  function previousImage() {
    if (modelElementList.indexOf(selected) == 0) {
      setSelected(modelElementList[modelElementList.length - 1]);
    } else {
      setSelected(modelElementList[modelElementList.indexOf(selected) - 1]);
    }
  }

  function nextImage() {
    if (modelElementList.indexOf(selected) + 1 == modelElementList.length) {
      setSelected(modelElementList[0]);
    } else {
      setSelected(modelElementList[modelElementList.indexOf(selected) + 1]);
    }
  }
...
//# sourceMappingURL=index.js.32787bbcb567d9c6e00e.hot-update.js.map